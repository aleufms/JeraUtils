...
class MaterialCheckFormView: UIView {
    ...
    var checkedImage = UIImage.fontAwesomeIconWithName(FontAwesome.CheckSquareO, textColor: UIColor(red: 238/255, green: 47/255, blue: 125/255, alpha: 1), size: CGSize(width: 36, height: 36)){
        didSet{
            refreshCheckImageView()
        }
    }
    
    var uncheckedImage = UIImage.fontAwesomeIconWithName(FontAwesome.SquareO, textColor: UIColor(red: 238/255, green: 47/255, blue: 125/255, alpha: 1), size: CGSize(width: 36, height: 36)){
        didSet{
            refreshCheckImageView()
        }
    }
